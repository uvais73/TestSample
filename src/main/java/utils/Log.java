...
public class Log {
	 ...
	 */
	public static String takeScreenShot(SelfHealingDriver driver) {
		String inputFile = "";
...
//    }
	...
	public static void assertThatExtentReport(boolean status, String passmsg, String failmsg, SelfHealingDriver driver) {
		if (!status) {
	 ...
	 */
	public static void message(String description, SelfHealingDriver driver, Boolean... takeScreenShot) {
	 ...
	 * @param driver      to take screenshot
	 */
	public static void pass(String description, SelfHealingDriver driver) {
		String inputFile = "";
		if (configProperty.getProperty("isTakeScreenShot") != null
	 ...
	 * @param driver      to take screenshot
	 */
	public static void fail(String description, SelfHealingDriver driver) {
		String inputFile = takeScreenShot(driver);
		Reporter.log("<!--FAIL-->");
		Reporter.log(
	 ...
	 * @param driver      to take screenshot
	 */
	public static void failsoft(String description, SelfHealingDriver driver) {
		String inputFile = takeScreenShot(driver);
	 ...
	 * @param driver      to take screenshot
	 */
	public static String buildfailsoftMessage(String description, SelfHealingDriver driver) {
		String inputFile = takeScreenShot(driver);
	 ...
	 * @throws Exception
	 */
	public static void exception(Exception e, SelfHealingDriver driver) throws Exception {
	 ...
	 */
	public static void assertThat(boolean status, String passMsg, String failMsg, SelfHealingDriver driver) {
		if (!status) {
			Log.fail(failMsg, driver);
		} else {
			Log.message(passMsg, driver);
	 ...
	 *                mapping to log report
	 */
	public static void softAssertThat(boolean status, String passMsg, String failMsg, SelfHealingDriver driver) {
		if (!status) {
